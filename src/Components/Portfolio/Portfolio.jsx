						...
						<Grid item container xs={12} md={4} direction='row'>
							...
							<Grid item xs={12}>
								<Typography variant='body1'>
									A mobile-first web app to provide cyclists with the tools for
									crowd-sourced tracking and rating of parking racks, fixing
									posts, and other cycling-related resources in their area.
								</Typography>
							</Grid>
