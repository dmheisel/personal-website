		...
		return (
			<Element id='Background' name='Background'>
				<Paper className={classes.root}>
					...
					<Divider />
					<Grid container spacing={2} justify="space-between" className={classes.contentGrid}>
										...
										<List dense>
											...
											<ListItem>
												<ListItemText>
													...
													environment to quickly develop a host of technical and
													interpersonal skills crucial for full stack software
													development.
												</ListItemText>
											</ListItem>
											<Divider />
								...
								<Card>
									...
									<CardContent>
										<List dense>
											<ListItem>
												<ListItemText>
													• Worked together with a team to brainstorm solutions
													to complicated policy issues and present possible
													solutions for policy oversights to MN DHS officials.
												</ListItemText>
											</ListItem>
											<Divider />
											<ListItem>
											...
											<ListItem>
												<ListItemText>
													...
													ever-changing state policy for programs, understanding
													the complicated statutes and laws.
												</ListItemText>
											</ListItem>
											<Divider />
											<ListItem>
